#!/usr/bin/env python3
# =========================================================
# query/main.py — Query module entry point
#
# Run from project root:   python query/main.py --chat
# Run from module dir:     cd query && python main.py --chat
#
# python main.py --ask "question"
# python main.py --ask "question" --filter state=Gujarat
# python main.py --chat
...
# Works whether called from root (python query/main.py)
# or from inside the module dir (cd query && python main.py)
    ...
    try:
        if "--stats" in args:
            ...
            if q:
                ...
                print('Usage: python main.py --search "keywords"')
