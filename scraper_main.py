#!/usr/bin/env python3
# =========================================================
# scraper_main.py  —  Scraper entry point (run from root)
#
# python scraper_main.py                          # continuous loop
# python scraper_main.py --once                   # single scrape run
# python scraper_main.py --stats                  # MongoDB stats
# python scraper_main.py --tender-active          # fetch open tenders
# python scraper_main.py --tender-results         # fetch awarded tenders
# python scraper_main.py --tender-file path.json  # load from local file
# python scraper_main.py --tender-stats           # tender collection stats
# python scraper_main.py --tender-active --category "Printing Work" --state Gujarat
# =========================================================
import sys
import os
    ...
    try:
        if "--stats" in args:
            ...
            if fp:
                ...
                print("Usage: python scraper_main.py --tender-file path/to/file.json")
