...
<table><tr><td colspan="2">बिड व</td></tr><tr><td colspan="2">बिड विवरण/Bid Details</td></tr><tr><td>क्या आप निविदाकारों द्वारा</td><td></td></tr></table>
...
5. Purchase preference to Micro and Small Enterprises (MSEs): Purchase preference will be given to MSEs having valid Udyam Certificate and whose credentials are validated online through Udyam Registration portal as defined in Public Procurement Policy for Micro and Small Enterprises (MSEs) Order, 2012 dated 23.03.2012 issued by Ministry of Micro, Small and Medium Enterprises and its subsequent Orders/Notifications issued by concerned Ministry. If the bidder wants to avail themselves of the Purchase preference, the bidder must be the manufacturer / OEM of the offered product on GeM. In respect of bid for Services, the bidder must be the Service provider of the offered Service. Traders are excluded from the purview of Public Procurement Policy for Micro and Small Enterprises and hence resellers offering products manufactured by some other OEM are not eligible for any purchase preference. Relevant documentary evidence in this regard shall be uploaded along with the bid in respect of the offered product or service, and Buyer will decide eligibility for purchase preference based on documentary evidence submitted in case of product bids, whereas in case of services the eligibility is automatically validated. If L-1 is not an MSE and MSE Seller (s) has / have quoted price within L-

8. Reverse Auction would be conducted amongst all the technically qualified bidders except the Highest quoting bidder. The technically qualified Highest Quoting bidder will not be allowed to participate in RA. However, H-1 will also be allowed to participate in RA in following cases:
...
<table><tr><td>विवरण/Specification</td><td>विशिष्टि का नाम /Specification Name</td><td>बिड के लिए आवश्यक अनुमत मूल्य /Bid Requirement (Allowed Values)</td></tr><tr><td rowspan="7">STANDARDS</td><td>Type of Signage Board</td><td>Non-illuminated Signage Board, Glow/illuminated Signage Board</td></tr><tr><td>Lighting Option in Signage Board</td><td>LED Backlit, LED Frontlit, Tube Light, Without Lighting</td></tr><tr><td>Material of Signage Board</td><td>ACP (Aluminium Composite Panel), Acrylic, PVC Foam Board, Stainless Steel (SS), Aluminum, Sunboard / Foam Sheet, Flex / Vinyl Boards, CRCA Mild Steel Sheet</td></tr><tr><td>Thickness of Signage board Material</td><td>3 mm, 5 mm, 8 mm, 10 mm, 12 mm, 2 mm</td></tr><tr><td>Frame Material</td><td>Aluminium, Mild Steel (MS) - Powder Coated, Stainless Steel (SS), Galvanized Iron (GI), PVC, NA (In case of No frame)</td></tr><tr><td>Mounting Type</td><td>Wall Mounted, Pole Mounted, Hanging Type, Ground Mounted</td></tr><tr><td>Length of the Signage Board (in Feet)</td><td>2 feet to 4 feet, 4.1 feet to 6 feet, 6.1 feet to 8 feet, 8.1 feet to 10 feet, 10.1 feet to 14 feet, 14.1 feet to 18 feet, 18.</td></tr></table>

अतिरिक विशिष्टि दस्तावेज /Additional Specification Documents

<table><tr><td>Applicable Drawing Document</td><td>View</td></tr></table>

परेषिती/रिपोर्टिंग अधिकारी तथा मात्रा/Consignees/Reporting Officer and Quantity

<table><tr><td>क्र.सं./S.No.</td><td>परेषिती/रिपोर्टिंग अधिकारी /Consignee Reporting/Officer</td><td>पता/Address</td><td>मात्रा /Quantity</td><td>डिलीवरी के दिना/Delivery Days</td></tr><tr><td>1</td><td>**********</td><td>**********JAMNAGAR</td><td>4</td><td>15</td></tr></table>

# Special terms and conditions-Version:1 effective from 08-10-2025 for category Signage Board (V4)

# 1. Note to Buyers and Sellers:

1. This category operates exclusively through the BID process. All procurements will be conducted via this mode only.  
2. Buyer may provide additional requirements at the time of BID creation.  
3. The requirements may include Logos, Graphics, Text, Font Style, Font Size, and Layout in accordance with the catalog specifications and size option selected.  
4. The Buyer may ensure accuracy of the information provided (spelling, formatting, and design) and Seller shall reproduce the details exactly as received.
...
Experience Criteria: The Bidder or its OEM {themselves or through reseller(s)} should have regularly, manufactured and supplied same or similar Category Products to any Central / State Govt Organization / PSU for 3 years before the bid opening date. Copies of relevant contracts to be submitted along with bid

in support of having supplied some quantity during each of the year. In case of bunch bids, the primary product having highest value should meet this criterion.
...
hereby declare that I shall not disclose the contract or any provision, specification, plan, design, pattern, sample or information thereof to any third party during and after expiry of Contract.
...
1. SIGNAGE BOARD SHOULD HAVE:  
2. ACP SHEET + M.S. PIPE FRAMING  
3. GOLD LETTERS  
4. LOGO GOLD OUTLINE WITH UV PRINT  
5. AIRCRAFT MODEL AND UNIT LOGOS WITH LIGHT

6. Bidders are to visit this station for measurement of blinds at various places and for collection of sample available at user section and additional requirements by the user.

7. Participating vendor should have past experience in same field. Proof is to be uploaded during Bid.

8. At the time of delivery, all items will be examined thorough 7 / 9 y. Items found with low quality material I And faulty, will be rejected. Same will have to replace by vendor.

9. Bidders have to give undertaking that installation of boards at various places according to user requirement will be borne by the bidder at no extra cost.

10. Bidders must have police verification done along with labourers as most of the work needs to be done in Technical Area Acceptance certificate of all the above mentioned conditions with company seal and stam

p is to be uploaded at the time of participating in gem bidding process

all the documents to be uploaded before opening of bids for Tech qualification.
...
- [* जेम केटेगर� �विश�� के अनुसार / As per GeM Category Specification](https://bidplus.gem.gov.in/bidding/bid/showCatalogue/0JVwQ22QGDuKgsZ0JFPewzk3cbS_p5Zo2G89Ehcpk3g)  <!-- page 4 -->
- [View](https://mkp.gem.gov.in/uploaded_documents/cms/tp/home_publ_sign_sign_si88236380/51/16/877/CategorySchema/gem_dgsnd_drawing_document/2025/10/6/signage_boards_designs_2025-10-06-11-01-56_0e613bca8ee36dd282c7c419dfef848a.pdf)  <!-- page 5 -->
- [यह �बड सामा�य शत� के अंतग�त भी शािसत है /This Bid is also governed by the General Terms and Conditions](https://admin.gem.gov.in/apis/v1/gtc/pdfByDate/?date=20260716)  <!-- page 9 -->