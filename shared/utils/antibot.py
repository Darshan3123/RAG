...
def sleep_page_load():    _sleep(*PAGE_LOAD_WAIT)
def sleep_between_cards(): _sleep(*BETWEEN_CARDS_WAIT)
def sleep_between_pages(): _sleep(*BETWEEN_PAGES_WAIT)
def sleep_filter_click():  _sleep(*FILTER_CLICK_WAIT)
def sleep_pdf_download():  _sleep(*PDF_DOWNLOAD_WAIT)
